<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aa.aspx.cs" Inherits="AdminZone_aa" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Attendance List for Art Attack</h4>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Branch/Year</th><th>College</th><th>Contact</th><th>Sketching</th><th>Best oo Waste</th><th>Face Painting</th><th>Rangoli</th><th>Attendance</th></tr>
