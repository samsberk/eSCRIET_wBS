<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OratorySkills.aspx.cs" Inherits="AdminZone_OratorySkills" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Oratory Skills (Odyssey) List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Attendance List for Odyssey</h4>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Branch/Year</th><th>College</th><th>Contact</th><th>Speech</th><th>Turncoat</th><th>Debate</th><th>Attendance</th></tr>
