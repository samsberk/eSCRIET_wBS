<%@ Page Language="C#" AutoEventWireup="true" CodeFile="minim.aspx.cs" Inherits="AdminZone_minim" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Attendance List for Minimilitia</h4>
