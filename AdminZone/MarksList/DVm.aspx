<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DVm.aspx.cs" Inherits="AdminZone_MarksList_DVm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Documentary Videos (Cineasta) List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Cineasta</h4>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Branch/Year</th><th>College</th><th>Cineasta</th></tr>
