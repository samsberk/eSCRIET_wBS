<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Thm.aspx.cs" Inherits="AdminZone_MarksList_Thm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Treasure Hunt List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Treasure Hunt</h4>
