<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LanCSm.aspx.cs" Inherits="AdminZone_MarksList_LanCSm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Lantastic (Counter Strike)</h4>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Branch/Year</th><th>College</th><th>Lantastic (CS)</th><th>Team</th></tr>
