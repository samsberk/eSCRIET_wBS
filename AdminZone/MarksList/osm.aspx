<%@ Page Language="C#" AutoEventWireup="true" CodeFile="osm.aspx.cs" Inherits="AdminZone_MarksList_osm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Odyssey</h4>
            <table border="1" style="width:100%;margin-top:20px;">
                <tr><th>Sr.No.</th><th>Student Name</th><th>Branch/Year</th><th>College</th><th>Speech</th><th>Turncoat</th><th>Debate</th></tr>
