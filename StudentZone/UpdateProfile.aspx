<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateProfile.aspx.cs" Inherits="StudentZone_UpdateProfile" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update Profile : CVGClub</title>
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    <form id="form1" runat="server">
        <br /><div class="container-fluid" style="color:black;min-height:100vh;">
			<div class="row" style="font-family:Calibri; font-size:17px;">
				...
				<div class="col-sm-6 form-group" style="background:ghostwhite;border-radius:10px;padding-left:15px;padding-right:15px;">
					<div class="row">
					<h3 style="font-weight:bold;text-align:center;"><span class="glyphicon glyphicon-edit"></span>  Updation Form</h3><hr />
						<div class="col-sm-6">
