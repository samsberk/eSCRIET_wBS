<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Qm.aspx.cs" Inherits="AdminZone_MarksList_Qm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quiz (Enquizitia) List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for Enquizitia</h4>
