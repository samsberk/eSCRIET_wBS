<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PPT.aspx.cs" Inherits="AdminZone_PPT" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PPT Competition List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Attendance List for PPT Competition</h4>
