<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pptm.aspx.cs" Inherits="AdminZone_MarksList_pptm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PPT Presentation List</title>
    <meta charset="utf-8"/>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h4 style="margin-top:20px;font-weight:bold;text-align:center;">Judgement List for PPT Presentation</h4>
